    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="button" class="btn btn-primary" id="btnSalvar" onclick="save('<?= base_url('fornecedores/salvar') ?>')">Salvar</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
...
<script>
    ...
    ///////////////////////////////
        ...
        table = $('#table').DataTable({
            ...
            responsive: true,
            order: [[1, "asc"]],
            ajax: "<?= base_url('/fornecedores/listar') ?>",
            language: {
    ...
    ////////////////////
        ...
        $.ajax({
            url : "<?= base_url('/fornecedores/editar') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
                $('#id').val(data.id_fornecedor);
                $('#nome').val(data.nome);
