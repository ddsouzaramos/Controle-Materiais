<?php
$data['titulo_pagina'] = 'Tipos de Materiais';
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="button" class="btn btn-primary" id="btnSalvar" onclick="save('<?= base_url('tipos_materiais/salvar') ?>')">Salvar</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
...
<script>
    ...
    $(document).ready(function() {
        load_tipos_materiais();
    });

    /////////////////////////////////
    function load_tipos_materiais() {
    /////////////////////////////////
        ...
        table = $('#table').DataTable({
            ...
            responsive: true,
            order: [[1, "asc"]],
            ajax: "<?= base_url('/tipos_materiais/listar') ?>",
            language: {
            ...
            },
            {
                ...
                titleAttr: 'Novo Tipo de Material',
                action: function () {
                    add();
                }
            },
    ...
    ////////////////////
        ...
        $.ajax({
            url : "<?= base_url('/tipos_materiais/editar') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
                $('#id').val(data.id_tipo_material);
                $('#descricao').val(data.descricao);
                $('#modal_form').modal('show');
                $('.modal-title').text('Editar Tipo do Material');
            },
